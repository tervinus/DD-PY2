...
class Battery:
    ...
    def state_of_charge(self) -> float:
        ...
        Пример:
        >>> battery1 = Battery(28, 0.05)  # Ошибка №1 - забыл указать аттрибуты класса
        >>> soc = battery1.state_of_charge()
        """
        ...
...
class Transmission:
    ...
    def change_stage(self, increment: int) -> None:
        ...
        :param increment: число переключаемых ступеней.Если >0 - повышение, если <0 - понижение
    ...
    def calculate_current_gear_ratio(self) -> Union[int, float]:
        ...
        Пример:
        >>> speed_box = Transmission(5, 1, 1.5)
        >>> reduction = speed_box.calculate_current_gear_ratio() # Ошибка №2  - был лишний >
        """
        ...
